...
<hr/>
 ...
 <table width="20%" border="0" align="center">
   ...
   <tr> <td height="43" align="center" class="btn-success"><strong>ADDMIN Please Login</strong> !</td> </tr>
   ...
   <tr><td height="40" align="center"><strong><i class="icon-lock"></i>&nbsp;Password</strong></td> </tr>
   ...
   <tr><td height="32" align="center">
   	   ...
   	   <button type="submit" name="button" id="button" class="btn btn-success"><i class="icon-check"></i>&nbsp;Login&nbsp;</button>
