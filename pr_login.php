...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "pr_oder/pr_index.php";
  $MM_redirectLoginFailed = "pr_login.php";
...
<table width="100%" border="0">
    ...
    <td width="753" align="center"><p><strong><img src="http://www.ufocool.com/images/flag/thailand.gif">&nbsp;&nbsp;Welcome to Purchase Order system</strong><strong>&nbsp;&nbsp;<img src="http://www.ufocool.com/images/flag/thailand.gif"></strong></p></td>
 ...
 <p><hr/>
 <form ACTION="<?php echo $loginFormAction; ?>" name="login_pr" method="POST">
