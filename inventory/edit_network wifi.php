...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE network_wifi SET device_id=%s, date_pr=%s, localtion=%s, brand=%s, model=%s, status=%s WHERE id=%s",
...
mysql_select_db($database_IT, $IT);
$query_EWF = sprintf("SELECT * FROM network_wifi WHERE id = %s", GetSQLValueString($colname_EWF, "int"));
$EWF = mysql_query($query_EWF, $IT) or die(mysql_error());
$row_EWF = mysql_fetch_assoc($EWF);
$totalRows_EWF = mysql_num_rows($EWF);
  ...
  <tr>
    ...
    <script src="assets/js/bootstrap-typeahead.js"></script></p>
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td height="32" align="left" nowrap><span class="label label-success"><strong>Update Inventory</strong></span>&nbsp;</td>
            <td align="left">&nbsp;</td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap align="left"><input type="text" name="device_id" value="<?php echo htmlentities($row_EWF['device_id'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            <td align="left"><input type="text" name="brand" value="<?php echo htmlentities($row_EWF['brand'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap align="left"><input type="text" name="date_pr" value="<?php echo htmlentities($row_EWF['date_pr'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            <td align="left"><input type="text" name="model" value="<?php echo htmlentities($row_EWF['model'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="30" align="left" nowrap>Localtion</td>
            <td align="left">Status</td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="left"><input type="text" name="localtion" value="<?php echo htmlentities($row_EWF['localtion'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            <td align="left"><input type="text" name="status" value="<?php echo htmlentities($row_EWF['status'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
        ...
        <input type="hidden" name="id" value="<?php echo $row_EWF['id']; ?>">
</form>
      <p>&nbsp;</p>
</body>
</html>
<?php
mysql_free_result($EWF);
?>
