...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "network_office")) {
  $insertSQL = sprintf("INSERT INTO network_office (device_id, date_pr, localtion, brand, model, status) VALUES (%s, %s, %s, %s, %s, %s)",
...
<body background="../images/1180422460.gif">
 ...
 date_default_timezone_set("Asia/Bangkok");
    ...
    <td width="678" align="center"><strong><img src="http://www.ufocool.com/images/flag/thailand.gif">&nbsp;&nbsp; Add your Network Office informetion&nbsp;&nbsp;<img src="http://www.ufocool.com/images/flag/thailand.gif"></strong></td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="network_office">
  <table width="50%" border="0" align="center">
    ...
    <tr>
      <td colspan="2" align="left"><button name="button" type="submit" class="btn btn-success" id="button" ><i class="icon-check"></i>&nbsp;&nbsp;Save!&nbsp;&nbsp;</button>      <button name="button2" type="reset" class="btn btn-danger" id="button2"><i class="icon-remove"></i>&nbsp;&nbsp;Cancel&nbsp;&nbsp;</button></td>
    </tr>
  </table>
