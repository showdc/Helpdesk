...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE table_printer SET device_id=%s, date_pr=%s, username=%s, `position`=%s, brand=%s, model=%s, department=%s, status=%s WHERE id=%s",
...
mysql_select_db($database_IT, $IT);
$query_EPT = sprintf("SELECT * FROM table_printer WHERE id = %s ORDER BY id DESC", GetSQLValueString($colname_EPT, "int"));
$EPT = mysql_query($query_EPT, $IT) or die(mysql_error());
$row_EPT = mysql_fetch_assoc($EPT);
$totalRows_EPT = mysql_num_rows($EPT);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
    <tr valign="baseline">
          <td height="40" align="left" nowrap><span class="label label-success"><strong>Update Inventory</strong></span></td>
          <td align="left">&nbsp;</td>
        </tr>
    <tr valign="baseline">
          <td height="25" align="left" nowrap><strong>Device : ID</strong></td>
          <td align="left"><strong>Brand</strong></td>
        </tr>
    <tr valign="baseline">
          <td nowrap align="left"><input type="text" name="device_id" value="<?php echo htmlentities($row_EPT['device_id'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          <td align="left"><input type="text" name="brand" value="<?php echo htmlentities($row_EPT['brand'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
        </tr>
    <tr valign="baseline">
          <td height="26" align="left" nowrap><strong>Date : PR</strong></td>
          <td align="left"><strong>Model</strong></td>
        </tr>
    <tr valign="baseline">
          <td nowrap align="left"><input type="text" name="date_pr" value="<?php echo htmlentities($row_EPT['date_pr'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          <td align="left"><input type="text" name="model" value="<?php echo htmlentities($row_EPT['model'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
        </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
          <td nowrap align="left"><input type="text" name="username" value="<?php echo htmlentities($row_EPT['username'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          <td align="left"><input type="text" name="status" value="<?php echo htmlentities($row_EPT['status'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
        </tr>
    <tr valign="baseline">
          <td height="32" align="left" nowrap><strong>Position</strong></td>
          <td align="left"><strong>Department</strong></td>
        </tr>
    <tr valign="baseline">
          <td nowrap align="left"><input type="text" name="position" value="<?php echo htmlentities($row_EPT['position'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          <td align="left"><input type="text" name="department" value="<?php echo htmlentities($row_EPT['department'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
        </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
          <td colspan="2" align="left" nowrap><button type="submit" class="btn btn-success"><i class="icon-upload"></i>&nbsp;Save&nbsp;</button>
        <a href="inventory_index.php">
            <button type="button" class="btn btn-danger"><i class="icon-remove"></i>&nbsp;Cancel&nbsp;</button>
            </a></td>
        </tr>
  </table>
      <input type="hidden" name="MM_update" value="form1">
      <input type="hidden" name="id" value="<?php echo $row_EPT['id']; ?>">
    </form>
<p>&nbsp;</p>
</body>
</html>
<?php
mysql_free_result($EPT);
?>
