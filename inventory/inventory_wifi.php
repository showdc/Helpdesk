...
$query_IWF = sprintf("SELECT * FROM network_wifi WHERE id = %s", GetSQLValueString($colname_IWF, "int"));
$IWF = mysql_query($query_IWF, $IT) or die(mysql_error());
$row_IWF = mysql_fetch_assoc($IWF);
$totalRows_IWF = mysql_num_rows($IWF);
?>
<!DOCTYPE HTML>
<html lang="en">
<head>
...
<table width="90%" border="0" align="center" class="table-bordered">
  ...
  <tr>
    ...
    <td>&nbsp;&nbsp;<?php echo $row_IWF['device_id']; ?></td>
    <td align="right"><strong>Brand :</strong></td>
    <td>&nbsp;&nbsp;<?php echo $row_IWF['brand']; ?></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td> &nbsp;&nbsp;<?php echo $row_IWF['date_pr']; ?></td>
    <td align="right"><strong>Model :</strong></td>
    <td>&nbsp;&nbsp;<?php echo $row_IWF['model']; ?></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;&nbsp;<?php echo $row_IWF['localtion']; ?></td>
    <td align="right"><strong>Status :</strong></td>
    <td>&nbsp;&nbsp;<?php echo $row_IWF['status']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
