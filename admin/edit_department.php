...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE department SET department=%s WHERE id=%s",
...
mysql_select_db($database_IT, $IT);
$query_EDP = sprintf("SELECT * FROM department WHERE id = %s", GetSQLValueString($colname_EDP, "int"));
$EDP = mysql_query($query_EDP, $IT) or die(mysql_error());
$row_EDP = mysql_fetch_assoc($EDP);
$totalRows_EDP = mysql_num_rows($EDP);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="department" value="<?php echo htmlentities($row_EDP['department'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="id" value="<?php echo $row_EDP['id']; ?>">
</form>
<p>&nbsp;</p>
</body>
</html><?php
mysql_free_result($EDP);
?>
